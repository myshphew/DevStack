  ...
  return (
    <div className="mx-auto flex h-20 container items-center justify-between">
        ...
        <div className="hidden items-center gap-8 text-sm font-medium md:flex">
            ...
            <a href="#technologies" className="text-slate-500 transition hover:text-pink-600">
                Technologies
            </a>
            <a href="#projects" className="text-slate-500 transition hover:text-pink-600">
                Projects
            </a>
            <a href="#about" className="text-slate-500 transition hover:text-pink-600">
                About
            </a>
            <a href="#contact" className="text-slate-500 transition hover:text-pink-600">
                Contact
            </a>
        </div>
        ...
        <button className="rounded-md p-2 text-slate-600 md:hidden">
            ☰
        </button>
